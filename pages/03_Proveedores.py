...
st.set_page_config(page_title="ALMAGAN | Proveedores", page_icon="🏢", layout="wide", initial_sidebar_state="collapsed")
...
from modules.suppliers import render_proveedores
render_proveedores(supabase)
